...
[![Latest Stable Version](https://poser.pugx.org/darcorm/yii2-fullcalendar/v/stable)](https://packagist.org/packages/darcorm/yii2-fullcalendar)
[![Total Downloads](https://poser.pugx.org/darcorm/yii2-fullcalendar/downloads)](https://packagist.org/packages/darcorm/yii2-fullcalendar)
[![Latest Unstable Version](https://poser.pugx.org/darcorm/yii2-fullcalendar/v/unstable)](https://packagist.org/packages/darcorm/yii2-fullcalendar)
[![License](https://poser.pugx.org/darcorm/yii2-fullcalendar/license)](https://packagist.org/packages/darcorm/yii2-fullcalendar)
[![composer.lock](https://poser.pugx.org/darcorm/yii2-fullcalendar/composerlock)](https://packagist.org/packages/darcorm/yii2-fullcalendar)
...
```
$ php composer.phar require darcorm/yii2-fullcalendar "V1.0.11"
```

or add

```
"darcorm/yii2-fullcalendar": "V1.0.11"
```
...
```php
<?= darcorm\fullcalendar\Fullcalendar::widget([
        'options'       => [
            'id'       => 'calendar',
            'language' => 'nl',
        ],
